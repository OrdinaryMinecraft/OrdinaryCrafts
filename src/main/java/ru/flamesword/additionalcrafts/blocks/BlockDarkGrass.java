...
public class BlockDarkGrass extends Block  implements IGrowable {
    ...
    public BlockDarkGrass() {
        ...
        this.setBlockName("darkgrassblock");
        ...
        this.setBlockTextureName("additionalcrafts:DarkGrass");
    }
        ...
        if (!p_149674_1_.isRemote)
        {
            ...
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    {
                        p_149674_1_.setBlock(i1, j1, k1, AdditionalCraftsBase.darkgrassblock);
                    }
                }
            }
        }
