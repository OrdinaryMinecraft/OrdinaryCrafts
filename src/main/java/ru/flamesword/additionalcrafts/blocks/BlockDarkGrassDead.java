...
public class BlockDarkGrassDead extends Block  implements IGrowable {

    private IIcon field_149991_b;
    private IIcon field_149993_M;

    public BlockDarkGrassDead() {
        super(Material.grass);
        this.setBlockName("darkgrassdeadblock");
        ...
        this.setBlockTextureName("additionalcrafts:DarkGrassDead");
    }

    @SideOnly(Side.CLIENT)
    public IIcon getIcon(int p_149691_1_, int p_149691_2_)
    {
        return p_149691_1_ == 1 ? this.field_149991_b : (p_149691_1_ == 0 ? AdditionalCraftsBase.darkdirtblock.getBlockTextureFromSide(p_149691_1_) : this.blockIcon);
    }
    ...
    public IIcon getIcon(IBlockAccess p_149673_1_, int p_149673_2_, int p_149673_3_, int p_149673_4_, int p_149673_5_)
    {
        ...
        {
            return AdditionalCraftsBase.darkdirtblock.getBlockTextureFromSide(p_149673_5_);
        }
        else
        {
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isRemote)
        {
            ...
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, AdditionalCraftsBase.darkdirtblock);
            }
            else if (p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) >= 9)
            {
                for (int l = 0; l < 4; ++l)
                {
                    ...
                    if (p_149674_1_.getBlock(i1, j1, k1) == AdditionalCraftsBase.darkdirtblock && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0 && p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2)
                    {
                        p_149674_1_.setBlock(i1, j1, k1, AdditionalCraftsBase.darkgrassblockdead);
                    }
                }
            }
        }
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.field_149993_M = p_149651_1_.registerIcon(this.getTextureName() + "_snow");
    }
